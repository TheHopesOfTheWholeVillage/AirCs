...
public static class SvrOverrideSettings
{
    ...
    public delegate void OnFoveateChangedCallback(Vector2 gain, float area);
    ...
    private static float eyeResolutionScaleFactor = 1.0f;    // 1.0f = original size
    ...
    private static float overlayResolutionScaleFactor = 1.0f;    // 1.0f = original size
   ...
   public static eDepth OverlayDepth
    ...
    public static Vector2 FoveateGain
    {
        ...
        set { foveateGain = value; OnFoveateChangedEvent.Invoke(foveateGain, foveateArea); }
    }

    public static float FoveateArea
    {
        get { return foveateArea; }
        set { foveateArea = value; OnFoveateChangedEvent.Invoke(foveateGain, foveateArea); }
    }
